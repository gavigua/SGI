...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() . TEMPLATEASSETS  ;?>dist/css/skins/_all-skins.min.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url() . TEMPLATEASSETS  ;?>plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url() . TEMPLATEASSETS  ;?>plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo base_url() . TEMPLATEASSETS  ;?>plugins/datepicker/datepicker3.css">
  <!-- Daterange picker -->
