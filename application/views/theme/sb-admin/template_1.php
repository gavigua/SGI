...
<html lang="es">
    <head>
        ...
        <!-- Menu Nestable -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() . TEMPLATEASSETSSGI ?>/js/jquery-nestable/jquery.nestable.css">
        <!-- Custom GratiaCms Styles -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() . TEMPLATEASSETSSGI ?>/css/gratiacms.css">
        <!-- jQuery -->
    ...
    <body>
        ...
        <script type="text/javascript" src="<?php echo base_url() . TEMPLATEASSETSSGI ?>js/jquery-validate/jquery.validate.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url() . TEMPLATEASSETSSGI?>js/jquery-validate/localization/messages_es.min.js"></script>
        <!--Block en Ajax-->
        <script type="text/javascript" src="<?php echo base_url() . TEMPLATEASSETSSGI ?>/js/jquery-blockUI/jquery.blockUI.js"></script>
        <!--Alertas-->
        <script type="text/javascript" src="<?php echo base_url() . TEMPLATEASSETSSGI ?>/js/bootbox.min.js"></script>
        <!--Menu Nestable-->
        <script type="text/javascript" src="<?php echo base_url() . TEMPLATEASSETSSGI ?>/js/jquery-nestable/jquery.nestable.js"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url() . TEMPLATEASSETSSGI ?>/js/gratiacms.js"></script>
        <script>
